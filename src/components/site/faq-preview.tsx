        ...
        */}
        ...
        >
          ...
          <div className="relative z-20 flex min-h-[380px] flex-col justify-end p-7">
            ...
            <WhatsAppLink
              className="mt-6 inline-flex items-center justify-center gap-2.5 rounded-[0.625rem] px-6 py-3.5 text-[14px] font-bold transition-transform hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
              style={{
